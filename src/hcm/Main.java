    ...
    public static void main(String[] args) throws Exception {
        try (
            ...
            while (true) {
                ...
                System.out.println("5. Thêm nhân viên (chỉ adminHCM)");
                System.out.println("6. Thêm chấm công (staffHCM, adminHCM)");
                ...
                switch (choice) {
                    ...
                    case 5:
                        ...
                        out.println("ADD NHANVIEN " + maNV + "|" + hoTen + "|" + ngaySinh + "|" + sdt + "|" + chucVu + "|" + luong + "|" + maPB + "|HCM");
